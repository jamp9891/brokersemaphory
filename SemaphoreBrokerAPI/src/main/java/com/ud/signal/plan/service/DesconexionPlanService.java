...
@Slf4j
public class DesconexionPlanService {
	...
	public ResponseEntity<ServiceResponse<Object>> getPlanDesconexionOrch(String intersection) {
		...
		try{
			JSONObject jsonInterseccion = this.getPlanDesconexion(intersection).block();
	...
	public Mono<JSONObject> getPlanDesconexion(String intersection){


		//consumir el api de token de latam devolviendo
		return webClient.get()
				.uri(signalPlanParameters.getPathPlanDesConexion()+"/"+intersection)
